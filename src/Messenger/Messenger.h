...
class Messenger{
    public:
        ...
        int handleUpdates(std::vector<BParasite_Data_S> parasiteData, std::vector<time_t> lastTimeDataReceived, std::vector<std::string> logFileNames);
        bool ping();
    ...
    private:
        ...
        void handleNewMessages(int numNewMessages, std::vector<BParasite_Data_S> parasiteData, std::vector<time_t> lastTimeDataReceived, std::vector<std::string> logFileNames);
        void debug(bool messageSent, String typeOfMessage, std::string plantName);
        void generateNewTmpHtml(std::string, std::string);
